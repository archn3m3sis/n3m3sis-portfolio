...
export function GoalIcon({ className, size = 160 }: Props) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <linearGradient id="gl_g1" x1="7.528" x2="41.024" y1="40.305" y2="7.17" gradientUnits="userSpaceOnUse">
      ...
      <path fill="url(#gl_g1)" d="M23,6C12.507,6,4,14.507,4,25s8.507,19,19,19s19-8.507,19-19S33.493,6,23,6z M23,38 c-7.18,0-13-5.82-13-13s5.82-13,13-13s13,5.82,13,13S30.18,38,23,38z M30,25c0,3.866-3.134,7-7,7c-3.866,0-7-3.134-7-7 c0-3.866,3.134-7,7-7C26.866,18,30,21.134,30,25z"/>
