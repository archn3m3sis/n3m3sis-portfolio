...
export function TypewriterIcon({ className, size = 160 }: Props) {
  return (
    <svg
    ...
    >
      <linearGradient
        id="oNyofbCKgCdylklKXx8Amxa_gr1"
        x1="24"
        x2="24"
        y1="29.044"
        y2="-6.044"
      ...
      <path
        fill="url(#oNyofbCKgCdylklKXx8Amxb_gr2)"
