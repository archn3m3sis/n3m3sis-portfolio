...
export function DoubleArrowIcon({ className, size = 160 }: Props) {
  return (
    <svg
    ...
    >
      <linearGradient
        id="e5QyiYJflh4bEjMSNaVfba_K517SMrMS0us_gr1"
        x1="-523.148"
        x2="-496.595"
        y1="-171.249"
        y2="-171.249"
      ...
      <path
        fill="url(#e5QyiYJflh4bEjMSNaVfba_K517SMrMS0us_gr1)"
        d="M3.999,34L3.997,24 c0-11.041,8.96-20.001,20.001-20.001c11.04,0,20.001,8.96,20.001,20v10c0,1.104-0.897,2-2,2c-1.104,0-2-0.896-2-2v-10 c0-8.831-7.171-16-16.001-16c-8.832,0-16.001,7.169-16.001,16l0.001,10c0.001,1.104-0.895,2-1.999,2C4.895,36,3.999,35.104,3.999,34 z"
      />
      <linearGradient
        id="e5QyiYJflh4bEjMSNaVfbe_K517SMrMS0us_gr3"
        x1="-518.524"
        x2="-502.01"
        y1="-160.627"
        y2="-160.627"
      ...
      <path
        fill="url(#e5QyiYJflh4bEjMSNaVfbe_K517SMrMS0us_gr3)"
